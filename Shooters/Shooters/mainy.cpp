...
int main()
{
	...
	//ALLEGRO_SAMPLE *song = al_load_sample("  .ogg");
	//ALLEGRO_SAMPLE *soundEffect = al_load_sample("  .wav");
	...
	al_destroy_display(display); //destroy our display objects 
	return 0;
}
